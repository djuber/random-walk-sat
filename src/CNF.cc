...
*/
int find_literal_to_change(problem phi){
 ...
 */
void invert_value_of_literal(int index, problem phi){
...
*/
void mutate_assignment(problem phi){
 ...
 */
void generate_random_assignment(problem phi){
  for(int index =  0; index < phi->variable_count; index++)
